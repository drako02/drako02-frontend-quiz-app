...
function JavaScriptQuiz() {
    const javascriptQuiz = quizData.quizzes.find(quiz => quiz.title === "JavaScript");
    ...
    const currentQuestion = javascriptQuiz.questions[currentQuestionIndex];
    // const correctOption = javascriptQuiz.questions[currentQuestionIndex].answer;
    ...
    const handleSubmit = () => {
        ...
        if (currentQuestionIndex === javascriptQuiz.questions.length - 1) {
