...
function AccessibilityQuiz() {
    const accessibilityQuiz = quizData.quizzes.find(quiz => quiz.title === "Accessibility");
    ...
    const currentQuestion = accessibilityQuiz.questions[currentQuestionIndex];
    // const correctOption = accessibilityQuiz.questions[currentQuestionIndex].answer;
    ...
    const handleSubmit = () => {
        ...
        if (currentQuestionIndex === accessibilityQuiz.questions.length - 1) {
